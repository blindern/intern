...
/*
    ...
    */
    class smbHash
    {
        ...
        public $sc = array(1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1);
        ...
        * @return array
        */
        public function lshift($count, $data)
        {
            $ret = array();
        ...
        * @return array
        */
        public function permute($in, $p, $n)
        {
            $ret = array();
            for ($i = 0; $i < $n; $i++) {
                $ret[$i] = $in[$p[$i] - 1]?1:0;
        ...
        */
        ...
        public function smb_hash($in, $key, $forw)
        {
        ...
        */
        ...
        public function mdfour64(&$A, &$B, &$C, &$D, $M)
        {
            $X = array();
            for ($i = 0; $i < 16; $i++) {
                $X[] = $M[$i];
        ...
        public function ROUND1(&$a, $b, $c, $d, $k, $s, $X)
        {
        ...
        public function ROUND2(&$a, $b, $c, $d, $k, $s, $X)
        {
        ...
        public function ROUND3(&$a, $b, $c, $d, $k, $s, $X)
        {
        ...
        */
        public function unsigned_shift_r($a, $b)
        {
            $z = 0x80000000;
            if ($z & $a) {
                $a = ($a >> 1);
